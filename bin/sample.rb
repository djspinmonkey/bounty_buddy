...
def print_shopping_list_for(sourced_bounties)
  sourced_bounties.each do |source, bounties|
...
bounties = [
  Bounty.new("Kill A Buncha Dregs", [:fallen], "Ikora"),
  Bounty.new("Kill A Buncha Guardians", [:pvp], "Ikora"),
  Bounty.new("Kill 10 Combatants With Solar Abilities", [:pve], "Ikora"),
  ...
  Bounty.new("Sniper Kills In Strikes", [:vanguard_ops], "Zavala"),
  Bounty.new("Grenade Kills In Crucible", [:crucible], "Shaxx"),
  Bounty.new("Teabag A Streamer", [:pvp], "Twitch"),
  Bounty.new("Deliver Eighty Billion Cookies", [:baking], "Eva"),
  Bounty.new("Kill 100 Combatants in Seasonal Activities", [:pve, :seasonal], "Clovis's Torso"),
  Bounty.new("Pick Up Three Seasonal Doodads", [:seasonal], "Clovis's Torso"),
  Bounty.new("Taunt A Wizard", [:hive], "Eris"),
...
print_shopping_list_for(optimizer.sourced_universal_bounties)
puts
